...
import { Settings, PieChart, FileText, Home, LogOut, UploadCloud, Users, DatabaseZap, SplitSquareHorizontal } from "lucide-react";
import {
  Sidebar,
  SidebarHeader,
  SidebarContent,
...
const allMenuItems = [
    ...
    { href: "/preprocessing", label: "Preprocessing", icon: DatabaseZap },
    { href: "/train-test-split", label: "Train/Test Split", icon: SplitSquareHorizontal },
